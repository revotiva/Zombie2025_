...
public class ladderSystem : MonoBehaviour
{
	...
	public bool jumpOnThirdPersonEnabled = true;

	public bool jumpOnFirstPersonEnabled = true;
	...
	public bool isJumpOnThirdPersonEnabled ()
	{
		return jumpOnThirdPersonEnabled;
	}

	public bool isJumpOnFirstPersonEnabled ()
	{
		return jumpOnFirstPersonEnabled;
	}
