...
public class mapCreator : MonoBehaviour
{
	...
	public const string mainManagerName = "Map Creator";
	...
	public void updateMainMapSystemList ()
	{
		int mapSystemInfoListCount = mapSystemInfoList.Count;

		for (int i = 0; i < mapSystemInfoListCount; i++) {
			if (!mapSystemList.Contains (mapSystemInfoList [i].mainMapSystem)) {
