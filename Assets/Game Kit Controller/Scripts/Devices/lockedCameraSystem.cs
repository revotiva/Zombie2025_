    ...
    public void setLockedCameraToEditorCameraPosition (int lockedCameraListIndex, int cameraTransformListIndex)
    {
        ...
        if (currentCameraEditor != null) {
            ...
            if (currentCameraAxis.lockedCameraPivot != null) {
                ...
                //GKC_Utils.unpackPrefabObject (gameObject);

                //axisTransform.SetParent (null);

                Vector3 temporalAxisPosition = axisTransform.position;
                Quaternion temporalAxisRotation = axisTransform.rotation;
                ...
                axisTransform.position = temporalAxisPosition;
                axisTransform.rotation = temporalAxisRotation;
            }
