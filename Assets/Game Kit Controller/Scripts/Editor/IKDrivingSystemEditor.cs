...
public class IKDrivingSystemEditor : Editor
{
	...
	public void showFreeMoveHandle (Transform currentTransform, string handleName, float handleRadius)
	{
		...
		var fmh_1133_78_638804734675573972 = Quaternion.identity; newFreeHandlePosition = Handles.FreeMoveHandle (currentFreeHandlePosition, handleRadius, snapValue, Handles.CircleHandleCap);
