...
public class objectiveEventSystemEditor : Editor
{
	...
	SerializedProperty delayToDisableMissionAcceptedPanel;
	...
	void OnEnable ()
	{
        ...
        delayToDisableMissionAcceptedPanel = serializedObject.FindProperty ("delayToDisableMissionAcceptedPanel");
	...
	public override void OnInspectorGUI ()
	{
        ...
        if (showMissionAcceptedPanel.boolValue) {
            EditorGUILayout.PropertyField (delayToDisableMissionAcceptedPanel);
        }
