...
public class footStepsManagerEditor : Editor
{
	...
	SerializedProperty useNoiseOnStepsEnabled;
	...
	void OnEnable ()
	{
        ...
        useNoiseOnStepsEnabled = serializedObject.FindProperty ("useNoiseOnStepsEnabled");
	...
	public override void OnInspectorGUI ()
	{
		...
		if (stepsEnabled.boolValue) {
			...
			GUILayout.BeginVertical ("Footstep Noise State List", "window");
            ...
            EditorGUILayout.PropertyField (useNoiseOnStepsEnabled); 
