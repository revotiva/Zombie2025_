...
public class remoteEventSystemEditor : Editor
{
    ...
    SerializedProperty remoteEventSystemName;
    SerializedProperty remoteEventSystemID;
    ...
    void OnEnable ()
    {
        ...
        remoteEventSystemName = serializedObject.FindProperty ("remoteEventSystemName");
        remoteEventSystemID = serializedObject.FindProperty ("remoteEventSystemID");
    ...
    public override void OnInspectorGUI ()
    {
        ...
        EditorGUILayout.PropertyField (remoteEventSystemName);
        EditorGUILayout.PropertyField (remoteEventSystemID);
    ...
    void showEventInfoListElement (SerializedProperty list)
    {
        ...
        EditorGUILayout.PropertyField (list.FindPropertyRelative ("useStringOnEvent"));
        if (list.FindPropertyRelative ("useStringOnEvent").boolValue) {
            EditorGUILayout.PropertyField (list.FindPropertyRelative ("eventToActivateString"));
        }

        if (list.FindPropertyRelative ("useRegularEvent").boolValue) {
            EditorGUILayout.Space ();

            if (GUILayout.Button ("Test Event", buttonStyle)) {
                if (Application.isPlaying) {
                    manager.callRemoteEvent (list.FindPropertyRelative ("Name").stringValue);
                }
            }
        }
