...
public class inventoryBankManagerEditor : Editor
{
    ...
    SerializedProperty loadCurrentBankInventoryFromSaveFile;
    SerializedProperty saveCurrentBankInventoryToSaveFile;
    ...
    void OnEnable ()
    {
        ...
        loadCurrentBankInventoryFromSaveFile = serializedObject.FindProperty ("loadCurrentBankInventoryFromSaveFile");
        saveCurrentBankInventoryToSaveFile = serializedObject.FindProperty ("saveCurrentBankInventoryToSaveFile");
    ...
    public override void OnInspectorGUI ()
    {
        ...
        GUILayout.BeginVertical ("Bank Inventory List (DEBUG)", "window");
        ...
        EditorGUILayout.PropertyField (loadCurrentBankInventoryFromSaveFile);
        EditorGUILayout.PropertyField (saveCurrentBankInventoryToSaveFile);
    ...
    void showInventoryList (SerializedProperty list)
    {
        ...
        if (GUILayout.Button ("Show/Hide Bank Inventory List", buttonStyle)) {
        ...
        if (list.isExpanded) {
            ...
            for (int i = 0; i < list.arraySize; i++) {
                ...
                if (i < list.arraySize && i >= 0) {
                    ...
                    string amountValue = " - " + currentElement.FindPropertyRelative ("amount").intValue;
                    ...
                    if (currentElement.isExpanded) {
                        expanded = true;
                        showInventoryListElementInfo (currentElement, expanded, i);
                    }
