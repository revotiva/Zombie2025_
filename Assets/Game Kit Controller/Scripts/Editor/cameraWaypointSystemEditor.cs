...
public class cameraWaypointSystemEditor : Editor
{
    ...
    SerializedProperty resetCameraPositionOnEnd;
    SerializedProperty resetCameraPositionSpeed;
    SerializedProperty cameraWaypointEnabled;

    SerializedProperty pausePlayerCameraEnabled;

    SerializedProperty useMainCameraTransform;

    SerializedProperty setThisTransformAsCameraParent;


    SerializedProperty ignoreWaypointOnFreeCamera;
    SerializedProperty ignoreWaypointOnLockedCamera;

    SerializedProperty ignoreWaypointOnFBA;

    SerializedProperty useEventToStopCutScene;
    SerializedProperty eventToStopCutscene;
    ...
    void OnEnable ()
    {
        ...
        resetCameraPositionOnEnd = serializedObject.FindProperty ("resetCameraPositionOnEnd");
        resetCameraPositionSpeed = serializedObject.FindProperty ("resetCameraPositionSpeed");

        cameraWaypointEnabled = serializedObject.FindProperty ("cameraWaypointEnabled");

        pausePlayerCameraEnabled = serializedObject.FindProperty ("pausePlayerCameraEnabled");

        useMainCameraTransform = serializedObject.FindProperty ("useMainCameraTransform");

        setThisTransformAsCameraParent = serializedObject.FindProperty ("setThisTransformAsCameraParent");

        ignoreWaypointOnFreeCamera = serializedObject.FindProperty ("ignoreWaypointOnFreeCamera");
        ignoreWaypointOnLockedCamera = serializedObject.FindProperty ("ignoreWaypointOnLockedCamera");

        ignoreWaypointOnFBA = serializedObject.FindProperty ("ignoreWaypointOnFBA");

        useEventToStopCutScene = serializedObject.FindProperty ("useEventToStopCutScene");
        eventToStopCutscene = serializedObject.FindProperty ("eventToStopCutscene");
            ...
            for (int i = 0; i < manager.waypointList.Count; i++) {
                if (manager.waypointList [i].waypointTransform != null) {
                    ...
                    if (manager.useHandleForWaypoints) {
                        ...
                        var fmh_129_70_638804734675109608 = Quaternion.identity; newPoint = Handles.FreeMoveHandle (oldPoint, manager.handleRadius, new Vector3 (.25f, .25f, .25f), Handles.CircleHandleCap);
    ...
    public override void OnInspectorGUI ()
    {
        ...
        EditorGUILayout.PropertyField (cameraWaypointEnabled);
        ...
        EditorGUILayout.PropertyField (ignoreWaypointOnFreeCamera);
        EditorGUILayout.PropertyField (ignoreWaypointOnLockedCamera);
        EditorGUILayout.PropertyField (ignoreWaypointOnFBA);
        ...
        EditorGUILayout.PropertyField (pausePlayerCameraEnabled);
        EditorGUILayout.PropertyField (resetCameraPositionOnEnd);
        EditorGUILayout.PropertyField (resetCameraPositionSpeed);
        EditorGUILayout.PropertyField (useMainCameraTransform);
        EditorGUILayout.PropertyField (setThisTransformAsCameraParent);
        ...
        EditorGUILayout.PropertyField (useEventToStopCutScene);
        if (useEventToStopCutScene.boolValue) {
            EditorGUILayout.PropertyField (eventToStopCutscene);
        }
        GUILayout.EndVertical ();
    ...
    void showWaypointListElementInfo (SerializedProperty list)
    {
        ...
        EditorGUILayout.PropertyField (list.FindPropertyRelative ("checkRotationIsReached"));
        GUILayout.EndVertical ();
