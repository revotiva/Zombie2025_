...
public class playerCameraEditor : Editor
{
    ...
    SerializedProperty pivotCameraMovementLerpSpeed;
    ...
    SerializedProperty toogleCameraViewToThirdFirstAndLockedEnabled;
    ...
    SerializedProperty reverseVerticalAccelerometer;
    SerializedProperty reverseHorizontalAccelerometer;
    ...
    SerializedProperty showCameraDebugState;
    ...
    void OnEnable ()
    {
        ...
        pivotCameraMovementLerpSpeed = serializedObject.FindProperty ("pivotCameraMovementLerpSpeed");
        ...
        toogleCameraViewToThirdFirstAndLockedEnabled = serializedObject.FindProperty ("toogleCameraViewToThirdFirstAndLockedEnabled");
        ...
        reverseHorizontalAccelerometer = serializedObject.FindProperty ("settings.reverseHorizontalAccelerometer");
        ...
        showCameraDebugState = serializedObject.FindProperty ("showCameraDebugState");
    ...
    public override void OnInspectorGUI ()
    {
        ...
        EditorGUILayout.PropertyField (pivotCameraMovementLerpSpeed);
        ...
        EditorGUILayout.PropertyField (toogleCameraViewToThirdFirstAndLockedEnabled);
        GUILayout.EndVertical ();
        ...
        if (showCameraDebugState.boolValue) {
            GUI.backgroundColor = Color.gray;
        } else {
            GUI.backgroundColor = defBackgroundColor;
        }
        if (GUILayout.Button ("Show Camera Debug State")) {
            showCameraDebugState.boolValue = !showCameraDebugState.boolValue;
        }
        ...
        if (showSettings.boolValue) {
            ...
            EditorGUILayout.PropertyField (reverseVerticalAccelerometer);
            EditorGUILayout.PropertyField (reverseHorizontalAccelerometer);
    ...
    void showCameraStateElementInfo (SerializedProperty list, int stateIndex)
    {
        ...
        EditorGUILayout.PropertyField (list.FindPropertyRelative ("useCustomMovementLerpSpeed"));
        if (list.FindPropertyRelative ("useCustomMovementLerpSpeed").boolValue) {
            EditorGUILayout.PropertyField (list.FindPropertyRelative ("movementLerpSpeed"));
        }
        GUILayout.EndVertical ();
        ...
        if (list.FindPropertyRelative ("leanEnabled").boolValue) {
            ...
            EditorGUILayout.PropertyField (list.FindPropertyRelative ("isLeanOnFBA"));
            if (list.FindPropertyRelative ("isLeanOnFBA").boolValue) {
                EditorGUILayout.PropertyField (list.FindPropertyRelative ("FBALeanPositionOffsetX"));
                EditorGUILayout.PropertyField (list.FindPropertyRelative ("FBALeanPositionOffsetY"));
            }
        }
        GUILayout.EndVertical ();
