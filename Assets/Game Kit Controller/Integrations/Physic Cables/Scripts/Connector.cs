...
namespace HPhysic
{
    ...
    public class Connector : MonoBehaviour
    {
        ...
        [SerializeField] public ConType ConnectionType { get; private set; } = ConType.Male;
        [SerializeField] public CableColor ConnectionColor { get; private set; } = CableColor.White;
